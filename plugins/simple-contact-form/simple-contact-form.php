...
function gCF()
{
	...
	if($display == "show")
	{
		...
		<form action="#" name="gcf" id="gcf">
		  ...
		  <div class="gcf_title"> Ваше имя </div>
		  <div class="gcf_title">
			<input name="gcf_name" class="gcftextbox field" type="text" id="gcf_name" maxlength="120">
		  </div>
		  <div class="gcf_title"> Ваш email </div>
		  <div class="gcf_title">
			<input name="gcf_email" class="gcftextbox field" type="text" id="gcf_email" maxlength="120">
		  </div>
		  <div class="gcf_title"> Введите текст вашего сообщения </div>
		  <div class="gcf_title">
			<textarea name="gcf_message" class="gcftextarea field" rows="3" id="gcf_message"></textarea>
		  </div>
		  <div class="gcf_title"> Введите код безопасности </div>
		  <div class="gcf_title">
			<input name="gcf_captcha" class="gcftextbox field" type="text" id="gcf_captcha" maxlength="6">
		  </div>
		  <div class="gcf_title tac">
		  	<img src="<?php echo get_option('siteurl'); ?>/wp-content/plugins/simple-contact-form/captcha.php?width=100&height=30&characters=5" />
		  </div>
		  <div class="gcf_title tac gcf_button">
			<input type="button" class="button" name="button" value="Отправить" onclick="javascript:gcf_submit(this.parentNode,'<?php echo get_option('siteurl'); ?>/wp-content/plugins/simple-contact-form/');">
		  </div>
